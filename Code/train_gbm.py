# META DATA - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
    ...
    # Description: This code snippet is used to train a Gradient Boosting Machine classifier with GridSearchCV
...
def train_gbm(data):
    ...
    # Here, we tune the number of estimators, learning rate, and max depth
    param_grid = {
